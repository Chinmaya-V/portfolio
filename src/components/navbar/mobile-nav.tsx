...
const NavLinks = ({
	...
	href: string
	label: string
	icon: ({ fill, size }: { fill?: string | undefined; size?: string | undefined }) => React.JSX.Element
}) => {
	...
	return (
		<button
			...
			className={`w-10 h-10 rounded flex flex-col items-center justify-center transition-all duration-200 ${
				href === link ? 'bg-purple-600/75 z-30 scale-125 shadow-[0_4px_24px_4px_rgba(139,92,246,0.7)]' : ''
			}`}
		>
